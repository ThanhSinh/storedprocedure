...
export interface IStudentClient {
    getTodoItem(): Observable<TodoItemBriefDto[]>;
    create(command: AddItem): Observable<number>;
    update(id: number, command: UpdateItem): Observable<FileResponse>;
        ...
        return this.http.request("get", url_, options_).pipe(_observableMergeMap((response_ : any) => {
            ...
            if (response_ instanceof HttpResponseBase) {
                try {
                    ...
                    return _observableThrow(e) as any as Observable<TodoItemBriefDto[]>;
                }
            } else
                return _observableThrow(response_) as any as Observable<TodoItemBriefDto[]>;
        }));
    }

    protected processGetTodoItem(response: HttpResponseBase): Observable<TodoItemBriefDto[]> {
        ...
        if (status === 200) {
            ...
            if (Array.isArray(resultData200)) {
                ...
                for (let item of resultData200)
                    result200!.push(TodoItemBriefDto.fromJS(item));
            }
            else {
                result200 = <any>null;
            }
